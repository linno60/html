MFD_controller = {
    ...
    run: function () {
        $('[data-obj=lnk-go], [data-obj=lnkgroup-go]').removeClass('active');
        $('[data-obj=lnk-go][href=#' + this.APP.settings.name + ']').addClass('active');
        $('[data-obj=lnkgroup-go]:has(.active)').addClass('active');

        document.title = "Hotels - " + $('[data-obj=lnk-go][href=#' + this.APP.settings.name + ']').text();
