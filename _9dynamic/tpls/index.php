    ...
    <body>
        <div class="lwrap" data-flex="col">
            <div>
                ...
                <section data-flex="axis" class="slider-wrap">
                    <a href="#"><i class="icon-prev"></i></a>
            ...
            <footer class="lwrap" data-flex='axis' data-flex-480="vaxis">
                <div data-flex-480="vaxis">
                    ...
                    <nav data-flex="w" data-flex-480="center w" class="links-footer">
                        <a href='#'>About</a>.
                        <a href='#'>Portfolio</a>.
                        <a href='#'>Services</a>.
                        <a href='#'>Clients</a>.
