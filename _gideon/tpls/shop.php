                ...
                <aside class="sidebar">
                    ...
                    <section class="categories-check">
                        ...
                        <div class="hdr clearfix">
                            <h3>categories</h3>                            
                            <label for="c1" class="btn-expand"></label>
                        </div>
                    ...
                    <section class="price-wrap">
                        ...
                        <div class="hdr clearfix">
                            <h3>price</h3>                            
                            <label for="c2" class="btn-expand"></label>
                        </div>
                        <form  action="#" method="post">
                            <div>
                            ...
                            <a href="#" class="btn-default">Filter</a>
                        </form>
                    </section>
                    <section class="brand">
                        ...
                        <div class="hdr clearfix">
                            <h3>brand</h3>                            
                            <label for="c3" class="btn-expand"></label>
                        </div>
                        <form action="#" method="post">
                    ...
                    <section class="rating">
                        ...
                        <div class="hdr clearfix">
                            ...
                            <label for="c4" class="btn-expand"></label>
                        </div>
                        <form action="#" method="post">
                    ...
                    <section class="discount">
                        ...
                        <div class="hdr clearfix">
                            <h3>discount</h3>                            
                            <label for="c5" class="btn-expand"></label>
                        </div>
                        <form action="#" method="post">
                    ...
                    <section class="availability-wrap">
                        ...
                        <div class="hdr clearfix">
                            ...
                            <label for="c6" class="btn-expand"></label>
                        </div>
                        <form  action="#" method="post">
