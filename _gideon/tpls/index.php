            ...
            <div class="lwrap content-wrap clearfix">
                <div class="content">
                    ...
                    <section class="article-wrap">
                        ...
                        <article class="clearfix">
                            <time class="lbl-date" datetime="2016-04-22"><big>22</big><small>April</small><span>2016</span></time>
                            <div>
                                <h3>The Day Gabby Returned to Congress to Make Her Voice</h3>
                                <div>
                                    <div class="details">
                                        <span class="lbl-default">Photography</span>
                                        <span class="name">Steve Smith</span>
                                    </div>
                                    <div>
                    ...
                    <section class="article-wrap">
                        ...
                        <article class="clearfix">
                            <time class="lbl-date" datetime="2016-04-17"><big>17</big><small>April</small><span>2016</span></time>
                            <div>
                                <h3>Sunstone is an organization that brings together</h3>
                                <div>
                                    <div class="details">
                                        <span class="lbl-default">Business</span>
                                        <span class="name">Steve Smith</span>
                                    </div>
                                    <div>
                    ...
                    <section class="article-wrap">
                        <figure><img src="/images/img2.jpg" width="838" height="388" alt=""></figure>
                        <article class="clearfix">
                            <time class="lbl-date" datetime="2016-04-09"><big>09</big><small>April</small><span>2016</span></time>
                            <div>
                                <h3>Taking Liberties, Taking Shortcuts</h3>
                                <div>
                                    <div class="details">
                                        <span class="lbl-default">Fashion</span>
                                        <span class="name">Steve Smith</span>
                                    </div>
                                    <div>
                        ...
                        <figure>
                            ...
                            <div class="soundcloud">
                                <div>
                                    ...
                                    <div><span>0.09</span> / <span>3.38</span></div>
                                </div>
                                <figure><img src="/images/rasterized.png" width="600" height="80" alt=""></figure>
                                <div class="soundbar">
                                    <a href="#"><i class="icon-volume"></i></a>
                                    <a href="#">Info</a>
                                    <a href="#"><i class="icon-download"></i></a>
                                    <a href="#"><i class="icon-tag"></i></a>
                                    <a href="#"><i class="icon-nocomments"></i></a>
                                </div>
                            </div>
                        </figure>
                        <article class="clearfix">
                            <time class="lbl-date" datetime="2016-04-30"><big>30</big><small>April</small><span>2016</span></time>
                            <div>
                    ...
                    <section class="article-wrap">
                        ...
                        <article class="clearfix">
                            <time class="lbl-date" datetime="2016-04-03"><big>03</big><small>April</small><span>2016</span></time>
                            <div>
