...
<html lang="en">
    ...
    <body>
        <header>
            <section class="contact-wrap" data-flex="row--end">
                <div class="contact" data-flex="row-center">
                    <div data-flex="row-center">
                        <div data-flex class="lbl lbl-mail"><i class="icon-mail"></i></div>
                        <a href="mailto:info@chicagorentfinders.com">info@chicagorentfinders.com</a>  
                    </div>
                    <div data-flex="row-center">
                        <div data-flex class="lbl lbl-phone"><i class="icon-phone"></i></div>
            ...
            <section class="nav-wrap">
                <div class="nav" data-flex="row--end">
                    <nav data-flex="row-center">
                        <a href="#" class="btn active"><em>Home</em><i class="icon-down"></i></a>
                        <a href="#" class="btn"><em>FAQ</em></a>
                        <span>.</span>
                        <a href="#" class="btn"><em>Apartment Search</em></a>
                        <span>.</span>
                        <a href="#" class="btn"><em>Contact Us</em></a>
                        <span>.</span>
                        <a href="#" class="btn"><em>Neighborhoods</em></a>
                        <span>.</span>
                        <a href="#" class="btn"><em>Rent Your Condo</em></a>
                        <span>.</span>
                        <a href="#" class="btn"><em>Blog</em></a>
                    </nav>
                </div>
            </section>
            <section class="slider-wrap">
                <a href="#" class="btn btn-slide-lg prev"><i class="icon-prev"></i></a>   
                <div class="header-slider" data-flex="row-center-between">
                    <div class="header-title">
                        <h1>We Help <span>you Find</span></h1>
                        <h2>Apartment That Best <span>Fit You</span></h2>
                    ...
                    <div class="form-wrap">
                        <div class="steps-wrap">
                            ...
                            <div class="steps" data-flex="row-center-between">
                                <div class="lbl lbl-number complete">1<span class="lbl lbl-accept"><i class="icon-accept"></i></span></div>
                                <div class="lbl lbl-number active">2</div>
                                <div class="lbl lbl-number">3</div>
                                <div class="lbl lbl-number">4</div>
                            </div>
                        </div>
                        <div class="form-hdr" data-flex="col--center">
                            <h3><span>Search</span> Rentals</h3>
                            <span>Want to find you home fast filll this up</span>
                        </div>
                        <form action="#" method="post">
                            <div>
                                <div data-flex="row-center">
                                    <label>Monthly<span> Rent&nbsp;:</span></label>
                                    <div class="range-wrap">
                                        <div class="range"></div>
                                        <div class="range-handle"></div>
                                    </div>
                                </div>
                                <div data-flex="row--end" class="range-title"><span>$500 to $5000</span></div>
                            </div>
                            <div class="neighborhoods">
                                <label>Neighborhoods</label>
                                <div  data-flex>
                                    <input type="checkbox" id="c1">
                                    <label for="c1" data-flex><span><i class="icon-check"></i></span>Streeterville</label>
                                    <input type="checkbox" id="c2" checked>
                                    <label for="c2" data-flex><span><i class="icon-check"></i></span>Gold Coast</label>
                                    <input type="checkbox" id="c3">
                                    <label for="c3" data-flex><span><i class="icon-check"></i></span>West Loop</label>
                                    <input type="checkbox" id="c4">
                                    <label for="c4" data-flex><span><i class="icon-check"></i></span>River North</label>
                                    <input type="checkbox" id="c5">
                                    <label for="c5" data-flex><span><i class="icon-check"></i></span>South Loop</label>
                                    <input type="checkbox" id="c6">
                                    <label for="c6" data-flex><span><i class="icon-check"></i></span>Old Town</label>
                                    <input type="checkbox" id="c7">
                                    <label for="c7" data-flex><span><i class="icon-check"></i></span>River West</label>
                                    <input type="checkbox" id="c8" checked>
                                    <label for="c8" data-flex><span><i class="icon-check"></i></span>Lakeshore East</label>
                                </div>                                
                            </div>
                            <div data-flex="row-center">
                                <label>Number of <span>Bedrooms:</span></label>
                                <span class="select">
