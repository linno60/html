        ...
        <div class="lwrap">
            <div class="wrap">
                ...
                <div class="content">
                    ...
                    <div class="grid profile" data-flex="row--between">
                        <article class="half">
                        ...
                        <div class="social">
                            ...
                            <div class="grid" data-flex="row--between">
                                ...
                                <a href="#" class="btn"><i class="icon-su"></i></a>
                    ...
                    <div class="grid works" data-flex="row--between">
                        <article>
                            <h5>Graphic Designer (Lead)</h5>
                            <em>Company Name - Jan 2011 - Present</em>
                    ...
                    <div class="grid skills" data-flex="row--between">
                        <div>
            ...
            <footer class="footer" data-flex="row--between">
                <div>
                    <span>Copyright © 2011.John Henry Doe. </span>
                    <span>Resume designed by<a href="#" class="link"> GraphicsFuel.com</a></span>
                </div>
                <div data-flex="col-end">
                    <span>Profile Picture Credit: <a href="#" class="link">Meathead Movers</a></span>
                    <a href="#">http://www.flickr.com/photos/meatheadmovers/5346940820/</a>
                </div>
            </footer>
        </div>
    </body>
