...
<html lang="en">
    ...
    <body>
        <div class="elements clearfix">
            ...
            <i class="icon-add-facebook"></i>
            <i class="icon-add-mail"></i>
            <i class="icon-add-plus"></i>
            <i class="icon-add-print"></i>
            <i class="icon-add-twitter"></i>
            ...
            <div class="select select-large">
                <label class="label-input clearfix"><i class="icon-label-country"></i><span>Country*</span></label>
                <span class="option">
                    <i class="icon-selectarrow-large"></i>
                </span>
                <select>
