...
<html lang="en">
    ...
    <body>
        <header>
            <div class="top-bar">
                <div class="lwrap" data-flex="axis" data-flex-480="vaxis">
                    ...
                    <div class="links-header" data-flex="-center end w"  data-flex-480="-center center w">
            ...
            <div class="header">
                <div class="lwrap" data-flex="axis">
                    <a href="#" title="Return to the homepage" id="logo" data-flex="col">
                        <img src="/images/logo.png" width="269" height="39" alt="Holy Church">
                        <span>revival & evangelism</span>
                    </a>
        ...
        <div class="lwrap">
            ...
            <div data-flex="vaxis">
                <div class="slider-wrap" data-flex="stripe" data-flex-800="vstripe">
                    ...
                    <div class="slider-caption">
                        ...
                        <div data-flex="end" data-flex-800="center">
