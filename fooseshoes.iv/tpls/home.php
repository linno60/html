        ...
        <section class="nav-wrap">
            ...
            <div class="top" data-flex>
                ...
                <div data-flex="col--center">
                    ...
                    <div data-flex>
                        <a href="#" class="btn btn-action"><i class="icon-eye"></i></a>
                        <a href="#" class="btn btn-action"><i class="icon-star"></i></a>
                        <a href="#" class="btn btn-action"><i class="icon-share"></i></a>
                        <a href="#" class="btn btn-action"><i class="icon-cart"></i></a>
                    </div>
                </div>
            </div>
        </section>
