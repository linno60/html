    ...
    <body data-flex="col"> 
        <div>
            <div class="lwrap">
                ...
                <section class="featured" data-flex="stripe w" data-flex-640="vstripe">
                    <article>
                        <h3><i class="icon-glass"></i><span>check out our latest projects</span></h3>
                    ...
                    <article>
                        <h3><i class="icon-star"></i><span>guarantee 5 star quality work</span></h3>
                        <p>Maecenas ipsum metus, semper hendrerit varius mattis, congue sit amet tellus. Aliquam ullamcorper dui sed magna posue re ut elementum enim rutrum. Nam mi erat, porta id ultrices nec, pellentesque vel nunc. Cras varius fermentum iaculis. Aenean sodales nibh non lectus tempor a interdum justo ultricies.</p>
                        <a href="#" class="link">find out more</a>
                    </article>
                    <article>
                        <h3><i class="icon-message"></i><span>stay conntectd by reading the blog</span></h3>
                        <p>Maecenas ipsum metus, semper hendrerit varius mattis, congue sit amet tellus. Aliquam ullamcorper dui sed magna posue re ut elementum enim rutrum. Nam mi erat, porta id ultrices nec, pellentesque vel nunc. Cras varius fermentum iaculis. Aenean sodales nibh non lectus tempor a interdum justo ultricies.</p>
                        <a href="#" class="link">find out more</a>
                    </article>
                </section>
