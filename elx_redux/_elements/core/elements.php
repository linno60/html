    ...
    <body class="_work">
        ...
        <div class="_elements clearfix">
            ...
            <div id="_tabs_box" class="_tabs">
                <?php foreach (['fonts','fonts-local','js','icons','images','buttons','labels','links','forms','tables','lists','paginations','tabs','cites','messages','other','css'] as $tab_name): ?>
                    <div id="_tab-<?=$tab_name?>">
                        <a href="#_tab-<?=$tab_name?>"><?=$tab_name?> <span></span></a>
                        
                        <?php $gen_class = !in_array($tab_name, ['fonts','fonts-local','js','icons','images','css']) ? '_tholder' : '';?>
                        ...
                        <div class="<?=$gen_class?>">
                            ...
                            <?php if(in_array($tab_name, ['fonts','fonts-local','js','icons','images'])): ?>
                                <a href="#" data-tab="<?=$tab_name?>" class="_btn-refresh"></a>
                            <?php endif; ?>
                                
                            <?php 
                                if (in_array($tab_name, ['icons','images','css']))
