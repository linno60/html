...
<html lang="en">
    ...
    <body>
        ...
        <section class='wrap'>
            <div class='slider'>
                <a href='#' class='btn btn-slider prev'><i class='icon-prev'></i></a>
                <img src="images/slide.png">
                <a href='#' class='btn btn-slider next'><i class='icon-next'></i></a>
            </div>
            <div class='services'>
                <h2>Our Services</h2>
                ...
                <div class="tabs">
                    <div class="_nav" data-flex='row-center-center'>
                        <a href="#tab1" class="btn active">Web Desin</a>
                        <a href="#tab2" class='btn'>Photography</a>
                        <a href="#tab3" class="btn">Graphics</a>
                    </div>
                    <div class="_content">
            ...
            <div class='customers'>
                ...
                <div class='grid' data-flex='row-center-between'>
                    <div>
        ...
        <footer>
            <div class='footer' data-flex='row--between'>
                ...
                <div>
                    <h6>twitter</h6>
                    <div class='tweet'>
                        <i class='icon-tweets'></i><p>Praesent commodo cursus magna Morbi leo risus nulla consectetur. -<a href='#'> 21 hours ago</a></p>
                    </div>
                    <div class='tweet'>
                        <i class='icon-tweets'></i><p>Vestibulum id ligula porta euismod semper. auctor dolor fermentum. -<a href='#'> 2 days ago</a></p>
                    </div>
                    <div class='tweet'>
                        <i class='icon-tweets'></i><p>Donec ullamcorper nulla non metus auctor. -<a href='#'> 3 days ago</a></p>
                    </div>
                </div>
                <div>
            ...
            <div class='copyright-wrap'>
                <div class='copyright' data-flex='row-center-between'>
                    <span>&copy; 2011 Ikaros. Theme by <a href='#'>elemis</a></span>
