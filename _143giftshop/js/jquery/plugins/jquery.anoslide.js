    ...
    anoSlide.prototype =
            {
                ...
                adapt: function ()
                {
                    ...
                    if (viewport.w < this.options.responsiveOne)
                    {
                        this.options.items = 1;
                    } else if (viewport.w < this.options.responsiveTwo)
                    {
                        this.options.items = 2;
                    } else if (viewport.w < this.options.responsiveThree)
                    {
                        this.options.items = 3;
                    } else if (viewport.w < this.options.responsiveFour)
                    {
