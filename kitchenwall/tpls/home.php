    ...
    <body>
        <header>
            <div class="lwrap" data-flex="row-center-between">
                <a href="#" class="logo">K<i class="icon-logo"></i>tchenwall</a>
        ...
        <div class="lwrap main" data-flex="row-start-between">
            <div class="content-wrap">
                ...
                <div class="hdr" data-flex="row-center-between">
                    <div data-flex="row-center">
                        ...
                        <span>|</span>
                        <span>Photography, Wine, Food</span>
                        <span>|</span>
                        <a href="#">12 Comments</a>
                    </div>
                    <a href="#" data-flex="row-center" class="like"><i class="icon-heart"></i>21</a>
                </div>
                <figure data-flex>
                ...
                <div class="thread">
                    ...
                    <div class="post"> 
                        <div data-flex="row-start">
                            ...
                            <div class="message" data-flex="col">
            ...
            <aside class="aside">
                <div class="popular-wrap">
                    ...
                    <div class="popular" data-flex="row-start">
                        ...
                        <div data-flex="col">
                            <a href="#">Vestibum Malesuada Etiam Magna</a>
                    ...
                    <div class="popular" data-flex="row-start">
                        ...
                        <div data-flex="col">
                            <a href="#">Mattis Egestas Fringilla Consectetur</a>
                    ...
                    <div class="popular" data-flex="row-start">
                        ...
                        <div data-flex="col">
                            <a href="#">Justo  Fermentum Tero Ultricies Pharetra</a>
                ...
                <div class="categories">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Gourmet (15)</a></li>
                        <li><a href="#">Salads (14)</a></li>
                        <li><a href="#">Wine (12)</a></li>
                    </ul>
                </div>
            </aside>
        </div>
