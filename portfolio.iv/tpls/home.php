...
<html lang="en">
    ...
    <body>
        <header data-flex='row-center-center'>
        ...
        <section class='direction-wrap' data-flex='col-center-center'>
            <div class='direction' data-flex='col-center-between'>
                <h2>what&nbsp;we&nbsp;do</h2>
                <article>
