(function ($) {
    ...
    $('._btn-refresh').click(function(e){
        ...
        {
            var P = {'css': $(this).parent().find('form').find('textarea').val()};
        ...
        {
            var P = {'js': $(this).parent().find('form').find('textarea').val()};
    ...
    CM_object = $('#_tab-js textarea');
    var CodeMirror_js = CodeMirror.fromTextArea( CM_object[0], { theme: 'mdn-like' });
