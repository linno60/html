    ...
    <body>
        <header>            
            <nav>
                ...
                <img src="images/camera.png" class="img-hd"> 
            </nav>
        ...
        <section class="subscribe">
            <form action="#" method="post">
                <label>subscribe tous community</label>
                <div>
                    <input type="text" placeholder="your email">
                    <button><span class="btn btn-check"></span></button>
                </div>
            </form>
        </section>
        <section class="download">
            <div>
                ...
                <div>
                    <a href="#" class="btn btn-store apple">apple store</a>
                    <a href="#" class="btn btn-store android">play store</a>
                </div>
            </div>
        </section>
        <footer>
