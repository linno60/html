        ...
        <div class="lwrap">
            <div>
                <header data-flex="axis">
                    <a href="/" title="Return to the homepage" id="logo">
                        <img src="/images/logo.png" width="249" height="80" alt="XTech">
                    </a>
                    <span><strong>call now!</strong>1-800-123-4567</span>
                </header>
                <div class="slider">
                    <h1>The perfect way to convert your traffic into sales.</h1>
                    <figure><img src="/images/groupimg.png" width="832" height="308" alt=""></figure>
                </div>
                <div class="features">
                    <div data-flex="axis">
                        <span></span>
                    ...
                    <div data-flex="stripe w" data-childs>
                        <article>
                            <i class="icon-desktop"></i>
                            <div>
                                <h4>Quick and easy</h4>
                                <p>Ma quande lingues coalesce, li grammatica del resultant lingue es plu simplic e regulari quam ti del coalescent lingues. Li nov lingua franca va esser plu simplic e regulari.</p>
                            </div>
                        </article>
                        <article>
                        ...
                        <article>
                            ...
                            <div>
                                <h4>Support - 24h</h4>
                                <p>It va esser tam simplic quam Occidental: in fact, it va esser Occidental.A un Angleso it va semblar un simplificat Angles</p>
                            </div>
                        </article>
                        <article>
                            <i class="icon-books"></i>
                            <div>
                                <h4>Well written help file</h4>
                                <p>Ma quande lingues coalesce, li grammatica del resultant lingue es plu simplic e regulari quam ti del coalescent lingues. Li nov lingua franca va esser plu simplic e regulari.</p>
                            </div>
                        </article>
                        <article>
            ...
            <footer>
                ...
                <div class="copyright" data-flex="axis">
                    <span>Copyright &copy; 2011 <a href="#">Shegy</a> - All rights resereved.</span>
