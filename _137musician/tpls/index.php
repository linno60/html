            ...
            <header data-flex="col">
                <section class="header" data-flex="-end">
                    <nav class="links-nav lwrap" data-flex="around w">
                        ...
                        <a href="#">con&shy;cert tours</a>
                        <a href="#">lat&shy;ter com&shy;posi&shy;tions</a>
                        <a href="#">new tracks</a>
                        <a href="#">up&shy;coming events</a>
                ...
                <div class="lwrap">
                    ...
                    <div class="article-wrap" data-childs="stripe w" data-childs-640="vstripe">
                        <div>
                            ...
                            <article data-flex='col between -start'>
                                <div>
                                    <p>Hell and Silence is an EP by Las Vegas rock group , released in March 2010 in the United States. It was recorded at Battle Born Studios. All songs were written by Imagine Dragons and self-produced. The EP was in part mixed by Grammy nominated engineer Mark Needham.</p>
                                    <p>To promote the album the band performed five shows at SXSW 2010 including at the BMI Official Showcase.While at SXSW they were endorsed by Blue Microphones. They also toured the western United States with Nico Vega and Saint Motel. They also performed at Bite of Las Vegas Festival 2010, New Noise Music Festival, Neon Reverb Festival, and Fork Fest.</p>  
                                </div>
                                <a href="#" class="btn btn-decor">play</a>
                            </article>
                        </div>
                        <div>
                            <h4>Night Visions is the debut studio album by American rock ba</h4>
                            <h3 class="title"><time>2012</time><hr>night visions</h3>
                            <article data-flex='col between -start'>
                                <div>
                        ...
                        <div>
                            <h4>The album was recorded during 2014 at the band's home studio in Las Vegas, Nevada</h4>
                            <h3 class="title"><time>2015</time><hr>smoke + mirrors</h3>
                            <article data-flex='col between -start'>
                                <div>
                    ...
                    <div data-childs data-childs-640="vstripe">
                        <div class="song-wrap">
                            <article data-flex="col around">
                                ...
                                <h4>Sam Feldt ft. Kimberly Anne - Show Me Love (EDX's Indian Summer Remix)</h4>
                                <p>"Radioactive" is a song recorded by American rock band Imagine Dragons for their major-label debut EP Continued Silence and later on their debut studio album, Night Visions (2012), as the opening track. "Radioactive" was</p>
                                <div data-flex="between -end">
                                    <a href="#" class="btn btn-default">Visit the iTunes<i class="icon-btnar"></i></a>
                                    <div class="links-media" data-flex="end w" data-childs="-center">
                                        ...
                                        <span><a href="#"><i class="icon-bubble"></i></a> 96</span>
                                    </div>
                                </div>
                            </article>
                            <figure data-video="16:9">
                                <iframe src="https://www.youtube.com/embed/egHjkeiqjrA"></iframe> 
                            </figure>
                        </div>
                        <div class="song-wrap">
                            <article data-flex="col around">
                                <h3 class="title"><time>20.07.2015</time><hr>indian sammer remix</h3>
                                <h4>Sam &nbsp;Feldt &nbsp;- &nbsp;Show &nbsp;Me &nbsp;Love &nbsp;(EDX's &nbsp;Indian Summer Remix)</h4>
                                <p>Amsterdam's Sam Feldt earned attention in Europe and then worldwide for his melodic house remixes, mixtapes, and collaborations including 2014's "Bloesem" with De Hofnar and "Hot Skin" with Kav Verhouzer on...</p>
                                <div data-flex="between -end">
                                    <a href="#" class="btn btn-default">Visit the iTunes<i class="icon-btnar"></i></a>
                                    <div class="links-media" data-flex="end w" data-childs="-center">
                                        <span><a href="#"><i class="icon-volume"></i></a> 12,289</span>
                                        <span><a href="#"><i class="icon-like"></i></a> 8 k</span>
                                        <span><a href="#"><i class="icon-share"></i></a> 1 k</span>
                                        <span><a href="#"><i class="icon-bubble"></i></a> 23</span>
                                    </div>
                                </div>
                            </article>
                            <figure data-video="16:9">
                                <iframe src="https://www.youtube.com/embed/fL9thGUW0PQ"></iframe>
                            </figure>
                        </div>
                        <div class="song-wrap">
                            <article data-flex="col around">
                                <h3 class="title"><time>03.04.2015</time><hr>chill nation</h3>
                                <h4>James Bay - Let It Go (Bearson Remix)</h4>
                                <p>A soulful singer/songwriter from a small English town with a penchant for crafting moving and evocative folk-pop confections in the vein of Ed Sheer&shy;an, Foy Vance, and Ben Howard, James Bay hails from the North Hertf...</p>
                                <div data-flex="between -end">
                                    <a href="#" class="btn btn-default">Visit the iTunes<i class="icon-btnar"></i></a>
                                    <div class="links-media" data-flex="end w" data-childs="-center">
                                        <span><a href="#"><i class="icon-volume"></i></a> 182,364</span>
                            ...
                            <figure data-video="16:9">
                                <iframe src="https://www.youtube.com/embed/ncp7JYzuJw4"></iframe>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <section class="news">
                <div class="lwrap" data-flex='stripe w' data-flex-480="vstripe">
                    <article>
                        ...
                        <p>A soulful singer/songwriter from a small En&shy;glish town with a penchant for crafting moving and evocative folk-pop confections in the vein of Ed Sheeran, Foy Vance, and Ben Howard, James Bay hails from the North Hertf shire market town of Hitchin. Bay honed his skills regionally, eventually landing high-expo-</p>
                        <b>01</b>
                    </article>
                    <article>
                        <h3 class="title"><time>01.03.2015</time><hr>chill nation</h3>
                        <h4>Smoke and Mirrors</h4>
                        <p>Hard Rock Cafe teamed with the band, grant&shy;ing them the first ever full access to take con&shy;trol of Hard Rock Cafe's internal video system (more than 20,000 screens at all 151 locations</p>
                        <b>02</b>
                    </article>
                    <article>
                        <h3 class="title"><time>04.04.2015</time><hr>chill nation</h3>
                        <h4>It Comes Back to You</h4>
                        <p>In 2015 a world tour, entitled the Smoke and Mirrors Tour is scheduled in promotion of the world-wide release of Smoke and Mirrors.</p>
                        <b>03</b>
                    </article>
                    <article>
                        <h3 class="title"><time>01.07.2015</time><hr>chill nation</h3>
                        <h4>Let It Go (Bear&shy;son Remix)</h4>
                        <p>A soulful singer/songwriter from a small En&shy;glish town with a penchant for crafting moving and evocative folk-pop confections in the vein of Ed Sheeran, Foy Vance, and Ben</p>
                        <b>04</b>
                    </article>
                    <article>
                        <h3 class="title"><time>02.11.2015</time><hr>chill nation</h3>
                        <h4>I Don't Mind</h4>
                        <p>Hell and Silence is an EP by Las Vegas rock group Imagine Dragons, released in March 2010 in the United States. It was recorded at Battle Born Studios.[1] All songs were written by Imagine Dragons and self-produced. The EP was in part mixed by Grammy nominated engineer Mark Needham.</p>
                        <b>05</b>
                    </article>
                    <article>
                        <h3 class="title"><time>06.09.2015</time><hr>chill nation</h3>
                        <h4>Smoke + Mirrors</h4>
                        <p>A soulful singer/songwriter from a small En-</p>
                        <b>06</b>
                    </article>
                </div>
            </section>
                ...
                <section>
                    ...
                    <div data-flex='stripe'>
                        <form action='#' method='post'>
                            ...
                            <input class="input-default" type="email" name="form" placeholder="E mail">
                            <textarea class="textarea-default" name="form" placeholder="Message"></textarea>
                            <button><span class="btn btn-submit">send</span></button>
                        </form>
                        <div class="links-social" data-flex="vaxis">
