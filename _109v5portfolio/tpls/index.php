...
<html lang="en">
    ...
    <body>
        <div class="lwrap" data-flex="vstripe">            
            <div>
                ...
                <div class="portfolio-wrap">
                    ...
                    <div data-flex="axis">
                        ...
                        <div class="portfolio" data-flex="stripe w">
                            <a href="#"><img src="/images/img1.png" width="190" height="123" alt=""></a>
                            <a href="#"><img src="/images/img2.png" width="190" height="123" alt=""></a>
                            <a href="#"><img src="/images/img3.png" width="190" height="123" alt=""></a>
                            <a href="#"><img src="/images/img4.png" width="190" height="123" alt=""></a>
                            <a href="#"><img src="/images/img5.png" width="190" height="123" alt=""></a>
                            <a href="#"><img src="/images/img6.png" width="190" height="123" alt=""></a>
                        </div>
            ...
            <footer>
                <div class="footer" data-flex="-start between" data-flex-480="vaxis">
                    <div data-flex="col -start">
                        <h2 class="hdr">get interested? hire me!</h2>
                    ...
                    <form action='#' method='post' data-flex='vaxis'>
                        ...
                        <input type="text" name="input" id='i1' placeholder="Enter your name here...">
                        <label for='i2'>Your E-Mail?</label>
                        <input type="email" name="input" id='i2' placeholder="Enter your e-mail address here...">
                ...
                <div class="copyright" data-flex="center"><a href="#">&copy; Sitename.com.</a>&nbsp;Design by ChocoTemplates.com</div>
            </footer>
        </div>
