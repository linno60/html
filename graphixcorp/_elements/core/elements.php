    ...
    <body class="_work">
        ...
        <div class="_elements clearfix">
            ...
            <div id="_tabs_box" class="_tabs">
                <?php foreach (['fonts','fonts-com','fonts-squirel','fonts-local','js','icons','images','rad-chk','labels','buttons','links','forms','tables','lists','paginations','tabs','cites','messages','other','css'] as $tab_name): ?>
                    ...
                    <div id="_tab-<?=$tab_name?>">
                        ...
                        <?php $gen_class = !in_array($tab_name, ['fonts','fonts-com','fonts-squirel','fonts-local','js','icons','images','css','rad-chk']) ? '_tholder' : '';?>
                        
                        <div class="<?=$gen_class?>">
                            
                            <!-- Background selection -->
                            
                            <?php if(!in_array($tab_name, ['fonts','fonts-com','fonts-squirel','fonts-local','js','css'])): ?>
                            ...
                            <?php if(in_array($tab_name, ['fonts','fonts-com','fonts-squirel','fonts-local','js','icons','images','rad-chk'])): ?>
