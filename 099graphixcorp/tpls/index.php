...
<html lang="en">
    ...
    <body>
        <div class="header-wrap">
            <div class="lwrap">
                <header class="header" data-flex="row-center between w" data-flex-480="col-center">
                ...
                <div class="slider-wrap" data-flex="col-center">
                    ...
                    <div class="hlinks links-categories" data-flex="w">
        ...
        <div class="lwrap">
            ...
            <div class="content" data-flex="between" data-flex-480="column">
                <article>
        ...
        <footer>
            ...
            <div class="lwrap">    
                <div class="footer">
                    <form action='#' method='post' data-flex='row-center between :grow(3)' data-flex-480="column">
                    ...
                    <div data-flex='between' data-flex-480="col">
                        <div data-flex='col'>
