...
<html lang="en">
    ...
    <body>
            ...
            <div>
                <div class="lwrap">
                    <div class="header" data-flex="row-center-between">
                        <a href="#" title="Return to the homepage" id="logo" data-flex><img src="/images/logo.png" width="234" height="53" alt="Repro"></a>
                        <figure data-flex><img src="/images/banner.png" width="468" height="60" alt=""></figure>
                    </div>
        ...
        <div class="content-wrap lwrap" data-flex>
            <div class="content">
                ...
                <div class="blog"> 
                    ...
                    <div class="post">
                        <figure data-flex class="figure"><img src="/images/img1.png" width="244" height="244" alt=""></figure>
                    ...
                    <blockquote data-flex="row-start">
                        <span>&ldquo;</span>
                        <q>Vestibulum id ligula porta felis euismod semper. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Aenean lacinia bibendum nulla sed consectetur. Integer posuere erat a ant</q>
                    </blockquote>
                    <div class="twocol">
                ...
                <div class="about">
                    <h3 class="hdr-sm" data-flex="row-center"><span>About the Author</span></h3>
                    <div data-flex="row-start">
                        <figure data-flex class="figure">
                            <img src="/images/img2.png" width="80" height="80" alt="">
                        </figure>
                        <p>Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Nulla vitae elit libero, a pharetra augue. Sed posuere consectetur est at lobortis. Nullam id dolor id nibh ultricies vehicula ut id elit. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Sed posuere</p>
                    </div>
                </div>
                <div class="related">
                    <h3 class="hdr-sm" data-flex="row-center"><span>Related Posts</span></h3>
                    <div data-flex>
                        <article>
                            <figure data-flex class="figure">
                                <img src="/images/img3.png" width="130" height="94" alt="">
                            </figure>
            ...
            <aside class="sidebar">
                ...
                <div class="grid" data-flex="row--between">
                    <figure data-flex><img src="/images/img125.png" width="125" height="125" alt=""></figure>
                    <figure data-flex><img src="/images/img125.png" width="125" height="125" alt=""></figure>
                    <figure data-flex><img src="/images/img125.png" width="125" height="125" alt=""></figure>
                    <figure data-flex><img src="/images/img125.png" width="125" height="125" alt=""></figure>
                </div>
                <div class="tabs">
                    <div class="_nav" data-flex="row--between">
                    ...
                    <div class="_content">
                        <div id="tab1" data-flex="col">
                            <div class="popular" data-flex="row-start">
                                <figure data-flex class="figure"><img src="/images/img5.png" width="45" height="45" alt=""></figure>
                                <div>
                                    <p><a href="#">Fly Fishers Serving as Transports for Noxious Little Invaders</a></p>
                ...
                <h3 class="hdr-sm" data-flex="row-center"><span>Video</span></h3>
                ...
                <div class="links-wrap" data-flex="row--between">
                    <div>
                        <h3 class="hdr-sm" data-flex="row-center"><span>Links</span></h3>
                    ...
                    <div>
                        <h3 class="hdr-sm" data-flex="row-center"><span>Sponsor</span></h3>
                        <figure data-flex><img src="/images/img120.png" width="120" height="240" alt=""></figure>
                    </div>
                </div>
            </aside>
        </div>
