...
<html lang="en">
    ...
    <body>
        <header>
            <div class="header" data-flex="row-center">
                <nav class='nav' data-flex>
                    ...
                    <a href="#" class="btn btn-nav">clients</a>
        ...
        <section class="slider-wrap" data-flex="row--between">
            ...
            <div class="slider-top" data-flex="row-center-center">
                <img src="images/img1.png">
                <div class='controls'>
                    <a href='#' class='btn btn-control'><span></span></a>
                    <a href='#' class='btn btn-control active'><span></span></a>
                    <a href='#' class='btn btn-control'><span></span></a>
                    <a href='#' class='btn btn-control'><span></span></a>
                </div>
            </div>
        ...
        <section class="slider-wrap blog" data-flex="row--between">
            ...
            <div class="slider-bottom">
                <h1>recent news from the blog</h1>
                <div class="grid" data-flex="row--between">
                    <article>
                        ...
                        <a href='#' class='btn btn-read'>Continue Reading..</a>
                    </article>
                    <article>
                        <h4>ut sagitti's ultrices urna eget</h4> 
                        <span>Posted on Step 5 by blugraphic.com</span>
