...
<html lang="en">
    ...
    <body>
        ...
        <div class="banner-wrap">
            <div class="lwrap banner" data-flex="row-center-center">
                    <figure data-flex>
                        <img src="/images/slider.png" width="873" height="353" alt="">
        ...
        <div class="lwrap">
            <div class="welcome" data-flex="row-center-between">
            ...
            <div class="grid" data-flex="row--between">
                <article>
                    <figure data-flex><img src="/images/img1.png" width="289" height="127" alt=""></figure>
                ...
                <article>
                    <figure data-flex><img src="/images/img2.png" width="289" height="127" alt=""></figure>
                    <h2>Fusce volutpat elementum</h2>
                    <p>Maecenas arcu lectus, vehicula vitae dignissim id, venenatis convallis urna. In vitae lacus et justo congue scelerisque. Duis purus neque, ultricies sed vulputate quis, vehicula at lorem. Praesent lobortis posuere tincidunt.</p>
                </article>
                <article>
                    <figure data-flex><img src="/images/img3.png" width="289" height="127" alt=""></figure>
                    <h2>Fusce volutpat elementum</h2>
                    <p>Maecenas arcu lectus, vehicula vitae dignissim id, venenatis convallis urna. In vitae lacus et justo congue scelerisque. Duis purus neque, ultricies sed vulputate quis, vehicula at lorem. Praesent lobortis posuere tincidunt.</p>
                </article>
            </div>
            ...
            <div class="lwrap" data-flex="row--between">
                ...
                <div>
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-subscribe" data-flex="row-center-between">   
