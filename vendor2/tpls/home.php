    ...
    <body>
        ...
        <div class="wrap-base">
                        ...
                        <div id="tabc1" class="tab-pane">
                            <div class="grid">
                                ...
                                <figure>                                   
                                    ...
                                    <div class="lbl lbl-price3">$1050</div>
                                        <img src="images/shape1.png" alt="">
                                    </a>
                                    <div class="ratings-container clearfix">
                                        <div class="ratings"></div>                                        
                                ...
                                <figure>                                    
                                    <a href="#" class="figure-wrapper">
                                        <div class="lbl lbl-price3"><span>$870</span>$710</div>
                                        <img src="images/shape1.png" alt="">
                                    </a>
                                    <div class="ratings-container clearfix">
                                        <div class="ratings">
                                ...
                                <figure>   
                                    <a href="#" class="figure-wrapper">
                                        <div class="lbl lbl-price3">$168</div>
                                        <img src="images/shape1.png" alt="">
                                    </a>
                                    <div class="ratings-container clearfix">
                                        <div class="ratings">
            ...
            <aside>
                <div class="newsletter">
                    <h3 class="h3">be the first to know</h3> 
                ...
                <div class="flexslider testimonials">
                    ...
                    <ul class="slides clearfix">
                        <li> 
                            ...
                            <div class="author">
                                <a href="#" class="avatar">
                                    <img src="images/avatar.png" width="70" height="70" alt="">
                                </a>
                                <div>
                        ...
                        <li> 
                            ...
                            <div class="author">
                                ...
                                <div>
                                    <a href="#" class="lnk-name">Jake Suasso</a>
                                    <time>17.05.2013</time>
                                </div>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="flexslider news">
                    ...
                    <ul class="slides clearfix">
                        ...
                        <li> 
                            <img src="/images/shape2.png" width="270" height="120" alt="">
                            <h5>25% Discount on second purchase!</h5>
                        ...
                        <li> 
                            <img src="/images/shape2.png" width="270" height="120" alt="">
                            <h5>15% Discount on second purchase!</h5>
                            <p>Sed blandit nulla nec nunc ullamcorper tristique. Mauris adipiscing cursus anteultricies dictum sed lobortis.</p>
                            <div class="caption">
                                <a href="#" class="lnk-read">Read More</a>
                                <time>12.05.2013</time>
        ...
        <footer>  
            ...
            <div class="footer-bottom">
                ...
                <span>&copy; 2012 Powered by WooCommerce&trade;. All Rights Reserved.</span>
            </div>
        </footer>
        ...
        <script>
            ...
            $(".sale-slider").owlCarousel({
                ...
                items: 3,
                itemsDesktop: [1170, 3],
                itemsDesktopSmall: [804, 2],
                itemsTablet: [478, 2],
                itemsMobile: [414, 1],
                navigationText: false
            });
            $(".manufacturers-slider").owlCarousel({
                navigation: true,
                pagination: false,
                itemsDesktop: [1170, 5],
