...
<div class="tabs podcasts" data-tabs>
    ...
    <div class="tabset">
        <div id="tab-p1" class="tabpanel active">Tab number 1</div>
...
<div class="tabs default alt" data-tabs="">
    ...
    <div class="tabset">
        <div id="tab-d1" class="tabpanel active">Tab number 1</div>
...
<div class="tabs default" data-tabs="">
    ...
    <div class="tabset">
        <div id="tab-d1" class="tabpanel active">Tab number 2</div>
        <div id="tab-d2" class="tabpanel">Tab number 2</div>
    </div>
    <div class="tab-ftr" data-flex="axis">
        <span> </span>
