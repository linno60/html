        ...
        <div class="lwrap">
            ...
            <div class="slider-wrap" data-flex="around w" data-flex-640="vstripe">
                ...
                <div class="slider" data-flex="axis">
                    ...
                    <figure><img src="/images/img2.png" width="460" height="288" alt=""></figure>
            ...
            <div class="services" data-flex="around" data-flex-640="vstripe" data-childs>
                <article>
                    <i class="icon-comp"></i>
                    <div>                            
                        <h3 class="title">Quick and easy</h3>
            ...
            <div class="features" data-flex="around"  data-flex-480="vstripe">
                <article>
                    <h3 class="title">Check out the features</h3>
            ...
            <div class="gallery">
                <h3 class="title">The screenshots</h3>
            ...
            <div class="testimonials">
                <h3 class="title">See what our customers are saying...</h3>
                ...
                <div class="footer" data-flex="stripe w">
                    ...
                    <div>
                        ...
                        <address data-flex="col">
                            <strong>123 Main Street #3</strong>
                            <span>San Francisco, CA, 94101</span>
                            <span><strong>Phone: </strong> (866) 123-4567 ext#1</span>
                            <span><strong>FAX: </strong> (866) 123-0000</span>
                            <span><strong>Email: </strong> <a href="mailto:webdesign@shegy.pl">webdesign@shegy.pl</a></span>
                        </address>
                    </div>
                    <div>
