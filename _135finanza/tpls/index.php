...
<html lang="en">
    ...
    <body data-flex="col">
                ...
                <section class="header">
                    <div class="lwrap" data-flex="axis">
                        <a href="/" title="Return to the homepage" id="logo">
                            <img src="/images/logo.png" width="199" height="36" alt="Finanza">
                        </a>
                        <div data-flex="-center">
                            <i class="icon-phone"></i>
                            <div>
                                <small>Call us now</small>
                                <strong>+44 00 000 123</strong>
                            </div>
                        </div>
                    </div>
                </section>
                <section class="lwrap form-wrap" data-flex="between -end" data-flex-800="vstripe">
                    ...
                    <div data-flex-800="vstripe">
                        ...
                        <form action="#" method="post">
                            ...
                            <small>* We don't share your personal info with anyone.</small>
                        </form>
                    </div>
                </section>
            </header>
        ...
        <footer>
            <section class='lwrap'>
                <div data-flex='around' data-childs='col -center'>
                    <div>
                        <div class="lbl lbl-default"><i class="icon-phoneb"></i></div>
                        <span>+44 00 00 1234</span>
                    </div>
                    <hr class='hr-v'>
                    <div>
            ...
            <section class='copyright'>
                <div class='lwrap'>
                    <span>Powered By PSDFreebies.com, Copyright 2017 All Right Reserved</span>
                </div>
            </section>
        </footer>
