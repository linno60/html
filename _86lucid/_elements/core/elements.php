...
<html lang="en" class="_work">
    <head>
        ...
        <link href="/css/addons/reset.css" rel="stylesheet">
        <link href="/css/addons/reset-elements.css" rel="stylesheet">
        <link href="/css/addons/data-flex.css" rel="stylesheet">
        <link href="/css/addons/data-tabs.css" rel="stylesheet">
        <link href="/css/addons/generic.css" rel="stylesheet">
    ...
    <body class="_work">
        ...
        <div class="_elements clearfix">
            ...
            <div id="_tabs_box" class="_tabs">
                <?php foreach (['fonts','fonts-com','fonts-squirel','fonts-local','js','icons','images','labels','buttons','links','forms','tables','lists','paginations','tabs','cites','messages','other','snippets'] as $tab_name): ?>
                
                    <!-- Removed fonts tab because we don't need to rename google fonts -->
                        <?php if ($tab_name === 'fonts') continue; ?>
                    <!-- End -->
                
                    <div id="_tab-<?=$tab_name?>">
                        <a href="#_tab-<?=$tab_name?>"><?=$tab_name?> <span></span></a>
                        
                        <!-- Apply _tholder class for tabs where tooltipster shows just HTML code without additional functionality -->
                        <?php $gen_class = !in_array($tab_name, ['fonts','fonts-com','fonts-squirel','fonts-local','js','icons','images','snippets']) ? '_tholder' : '';?>
                        
                        <div class="<?=$gen_class?>">
                            
                            <!-- Background selection -->
                            
                            <?php if(!in_array($tab_name, ['fonts','fonts-com','fonts-squirel','fonts-local','js','snippets'])): ?>
                            ...
                            <?php if(in_array($tab_name, ['fonts','fonts-com','fonts-squirel','fonts-local','js','icons','images'])): ?>
                                <a href="#" data-tab="<?=$tab_name?>" class="_btn-refresh"></a>
                            <?php endif; ?>
                                
                            <!-- Delete button -->
                            <?php if(in_array($tab_name, ['fonts-com','fonts-squirel'])): ?>
                                <a href="#" data-tab="<?=$tab_name?>" class="_btn-delete"></a>
                            <?php endif; ?>                            
                                
                            <!-- Where TPL is located -->
                            
                            <?php 
                                if (in_array($tab_name, ['icons','images','snippets']))
                                   $cur_tpl_path = '/_elements/generic/';
                                else if (in_array($tab_name, ['fonts-com','fonts-squirel','fonts-local','fonts','js']))
        ...
        <!-- Should be on frontend if required -->
