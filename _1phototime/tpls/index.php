...
<html lang="en">
    ...
    <body>
        ...
        <section class="subscribe" data-flex="col -center center">
        ...
        <section class="download">
            <div class="lwrap" data-flex="vaxis">
                ...
                <div>
                    <a href="#" class="btn btn-alt" data-childs="-center center"><em>apple store</em><span><i class="icon-apple"></i></span></a>
                    <a href="#" class="btn btn-alt" data-childs="-center center"><em>play store</em><span><i class="icon-android"></i></span></a>
                </div>
            </div>
        </section>
