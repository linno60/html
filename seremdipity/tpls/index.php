...
<html lang="en">
    ...
    <body>
        ...
        <div class="slider" data-flex="row--between">
            ...
            <div class="lwrap">
                <figure data-flex><img src="/images/imglg.png" width="1040" height="465" alt=""></figure>
            </div>
            <a href="#" class="btn btn-thumb"><i class="icon-right"></i></a>
        </div>
        <div class="lwrap">
            <div class="wrap contain">
                ...
                <div class="grid" data-flex="row--between">
                    <article>
                        <figure data-flex><img src="/images/img1.png" width="301" height="190" alt=""></figure>
                        <h3><a href="#">tellus egestas parturient</a></h3>
                        <span class="details"><time>21.03.2012</time><small>|</small><a href="#">#photograpy</a>, <a href="#">#journal</a></span>
                        <p>Nullam quis risus eget urna mollis ornare vel eu leo. Maecenas sed diam </p>
                    </article>
                    <article>
                        <figure data-flex><img src="/images/img1.png" width="301" height="190" alt=""></figure>
                        <h3><a href="#">justo condimentum fringilla</a></h3>
                        <span class="details"><time>21.03.2012</time><small>|</small><a href="#">#photograpy</a>, <a href="#">#journal</a></span>
                        <p>Cras mattis consectetur purus sit amet fermentum. Sed posuere consectetur.</p>
                    </article>
                    <article>
                        <figure data-flex><img src="/images/img1.png" width="301" height="190" alt=""></figure>
                        <h3><a href="#">egestas condimentum venenatis</a></h3>
                        <span class="details"><time>21.03.2012</time><small>|</small><a href="#">#photograpy</a>, <a href="#">#journal</a></span>
                ...
                <div class="posts">
                    ...
                    <div class="post">
                        <article data-flex="row-start">
                            <figure data-flex><img src="/images/img2.png" width="80" height="80" alt=""></figure>
                            <div>
                                <h4>ted evelyn mosby</h4>
                                <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum id ligula porta felis euismod semper. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Maecenas faucibus mollis interdum.</p>                            
                            </div>
                        </article>
                        <div class="post">
                            <article data-flex="row-start">
                                ...
                                <div>
                                    ...
                                    <p>Etiam porta sem malesuada magna mollis euismod. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Praesent commodo cursus magna, vel scelerisque nisl consectetur </p>                            
                                </div>
                            </article>  
                        </div>
                    </div>
            ...
            <footer class="footer" data-flex="row--between">
                <div>
                    <h5>popular posts</h5>
                ...
                <div>
                    ...
                    <p>Donec id elit non porta gravida at eget metus. Nullam quis</p>
                </div>
                <div>
                    <h5>contact form</h5>
