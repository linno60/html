    ...
    <body>
        <header>
            <div class="lwrap" data-flex="row-center-between">
                <a href="#" class="logo">Tempees<span>.com</span></a>
        ...
        <div class="slider-wrap" data-flex="row-center-between">
            <a href="#" data-flex="row-center"><i class="icon-prev"></i>Next Article</a>
            <div class="lwrap" data-flex="row-center-end">
                ...
                <nav class="links links-smallmenu">
                    ...
                    <a href="#" class="active">Vulputate</a>
                    <a href="#">Ac vel lectus</a>
                </nav>
            </div>
            <a href="#" data-flex="row-center">Previous Article<i class="icon-next"></i></a>
        </div>
        <div class="submenu">
        ...
        <div class="lwrap content">
            <article>
                <hgroup data-flex="row-center-between">
                    <h2>Proin eu lorem in justo mollis ullamcorper in a neque.</h2>
                    <div class="details" data-flex="row-center">
