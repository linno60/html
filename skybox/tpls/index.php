    ...
    <body>
        <header>
            <div class="lwrap">
                <div class="header" data-flex="row-center-between">
                    <a href="#" class="logo" data-flex="row-center"><i class="icon-logo"></i>Skybox</a>
                ...
                <figure class="banner" data-flex>
                    <img src="/images/slider.png" width="940" height="470" alt="">
                </figure>
            </div>
        </header>
        <div class="lwrap works">
            ...
            <div class="grid" data-flex="row--between">
                <article>
                    <h4 data-flex="row-center"><div class="lbl lbl-default"><i class="icon-comp"></i></div>Web Design</h4>
                ...
                <article>
                    <h4 data-flex="row-center"><div class="lbl lbl-default"><i class="icon-design"></i></div>Graphic Design</h4>
                ...
                <article>
                    <h4 data-flex="row-center"><div class="lbl lbl-default"><i class="icon-film"></i></div>Motion Graphic</h4>
                ...
                <article>
                    <h4 data-flex="row-center"><div class="lbl lbl-default"><i class="icon-camera"></i></div>Photography</h4>
                ...
                <article>
                    <h4 data-flex="row-center"><div class="lbl lbl-default"><i class="icon-pacman"></i></div>Phone Games</h4>
                    <p>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum., commodo cursus magna, vel scelerisque.</p>
                </article>
                <article>
                    <h4 data-flex="row-center"><div class="lbl lbl-default"><i class="icon-brush"></i></div>Illustration</h4>
        ...
        <div class="projects">
            ...
            <div data-flex="row--center">
                ...
                <figure data-flex>
                    <img src="/images/img2.png" width="370" height="250" alt="">
                </figure>
                <figure data-flex>
                    <img src="/images/img3.png" width="220" height="250" alt="">
                </figure>
                <figure data-flex>
                    <img src="/images/img4.png" width="260" height="250" alt="">
                </figure>
                <figure data-flex>
        ...
        <div class="lwrap">
            <div class="blogs">
                ...
                <div class="grid" data-flex="row--between">
                    <article>
                        <h4 data-flex="row-center"><time class="lbl lbl-default"><strong>21</strong><small>sep</small></time>Magna Mollis Ultricies Euismod Fermentum Elit</h4>
                        <figure data-flex>
                            <img src="/images/blog-img.png" width="292" height="140" alt="">
                        </figure>
                    ...
                    <article>
                        <h4 data-flex="row-center"><time class="lbl lbl-default"><strong>20</strong><small>sep</small></time>Ornare Nullam Risus Mollis Parturient</h4>
                        <figure data-flex>
                            <img src="/images/blog-img.png" width="292" height="140" alt="">
                        </figure>
                    ...
                    <article>
                        <h4 data-flex="row-center"><time class="lbl lbl-default"><strong>18</strong><small>sep</small></time>Euismod Nullam Vehicula Elit Venenatis Consectetur</h4>
                        <figure data-flex>
                            <img src="/images/blog-img.png" width="292" height="140" alt="">
                        </figure>
            ...
            <div class="about">
                ...
                <div class="grid" data-flex="row-start-between">
                    <div class="links links-default">
                        ...
                        <a href="#"><span>02.&nbsp;</span>Amet Parturient Cursus</a>
                        <a href="#"><span>03.&nbsp;</span>Magna Vulputate Adipiscing</a>
                        <a href="#"><span>04.&nbsp;</span>Nibh Consectetur Dolor</a>
                        <a href="#"><span>05.&nbsp;</span>Dolor Vehicula Cras</a>
                    </div>
                    <article class="about-content">
                        ...
                        <div>
                            <figure data-flex>
                                <img src="/images/article-img.png" width="200" height="150" alt="">
                            </figure>
        ...
        <footer>
            <div class="lwrap grid" data-flex="row--between">
                <div>
                    <h5>Popular Posts</h5>
                    <div class="post">
